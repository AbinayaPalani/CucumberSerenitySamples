...
public class CreatePlansAddonsStepDefinition {
	...
	public class CreatePlanSteps{
		...
		public void createObjectForPlansAndAddons(){
			...
			createPlans.put("brandId", CreateProfileStepDefinition.getBrandId.get("brandId"));
			...
			createPlans.put("activeSinceDate",todayDate);
			createPlans.put("dateCreated", todayDate);
		...
		public void checkOrderStatusThroughGetService(){
			 ...
			 Assert.assertEquals("Voice PlanId is not equal to given data with selected plan id", GetPlansAndAddonsStepDefinition.voicePlanId, voiceObject.get("id"));
					 
			 Assert.assertEquals("IVR PlanId is not equal to given data with selected plan id", GetPlansAndAddonsStepDefinition.ivrPlanId, ivrObject.get("id"));
